...
const config: NextConfig = {
  ...
  serverExternalPackages: ["@prisma/client", ".prisma/client", "@prisma/adapter-mariadb", "mariadb", "jspdf", "jspdf-autotable", "leaflet", "react-leaflet", "xlsx", "bcryptjs", "nodemailer"],
  images: {
    remotePatterns: [
      {
        protocol: 'https',
